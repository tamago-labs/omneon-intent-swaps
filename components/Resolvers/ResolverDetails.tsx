        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-slate-700/30 rounded-lg p-4 text-center">
              <div className={`text-2xl font-bold mb-1 ${getReputationColor(resolver.reputation)}`}>
                {resolver.reputation}
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 text-center">
              ...
              <div className="text-slate-400 text-sm">Orders (24h)</div>
            </div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 text-center">
              <div className="text-xl font-bold text-purple-400 mb-1">
                {avgExecutionTime > 0 ? `${avgExecutionTime.toFixed(1)}s` : 'N/A'}
              </div>
              <div className="text-slate-400 text-sm">Avg Time</div>
            </div>
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 text-center">
              <div className="text-xl font-bold text-yellow-400 mb-1">
                {utils.formatPercentage(resolver.feeRate)}
              </div>
              <div className="text-slate-400 text-sm">Fee Rate</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <div className="text-2xl font-bold text-white">{failedOrders.length}</div>
            </div>
          </div>
